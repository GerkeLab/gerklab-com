---
title: "shinyDAG"
description: "A Shiny app to create, visualize, and analyze causal diagrams (DAGs)"
author: "Jordan Creed"
weight: 10
draft: false
toc: false
callout: |
  **shinyDAG** is a web application that uses R and LaTeX to create
  publication-quality images of directed acyclic graphs (DAGs). Additionally,
  the application leverages complementary R packages to evaluate correlational
...
![](https://raw.githubusercontent.com/GerkeLab/ShinyDAG/master/Figures/AddNodeEdge.gif)

### Editing DAG aesthetics

![](https://raw.githubusercontent.com/GerkeLab/ShinyDAG/master/Figures/editEdge.gif)
...
![Hernan Example](https://raw.githubusercontent.com/GerkeLab/ShinyDAG/master/Figures/example1.png "Hernan Example")

For comparison, the DAG from the original article is shown below.

![Hernan Original](https://raw.githubusercontent.com/GerkeLab/ShinyDAG/master/Figures/example1_hernan.png "Hernan Original")
...
![shinyDAG path output](https://raw.githubusercontent.com/GerkeLab/ShinyDAG/master/Figures/paths.png "shinyDAG path output")
...
![shinyDAG final path output](https://raw.githubusercontent.com/GerkeLab/ShinyDAG/master/Figures/paths2.png "shinyDAG final path output")
