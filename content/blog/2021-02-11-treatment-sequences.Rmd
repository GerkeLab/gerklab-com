---
title: Exploring longitudinal treatment sequences
description: A brief R + {reactable} pattern paired that makes drug or treatment sequences quickly searchable
author: 
  - "Travis Gerke"
date: '2021-02-11'
slug: treatment-sequences
categories:
  - R
tags:
  - Tips
...
This post demonstrates a brief R pattern paired with [[reactable]]{.pkg} that makes drug or treatment patterns quickly searchable by an end-user via `.html` report. 
