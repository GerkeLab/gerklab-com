...
1. Two pairs of values came from an old coding system when the values `0` and `60` were used instead of `1` and `2`, respectively (rows `r knitr::combine_words(which(example_data$sequence %in% c("0", "60")))`). 
